function lgraph = structure4(input_size,num_channels)
...
layers = [
    ...
    'BiasL2Factor', 0, ...
    'Weights',sqrt(2/(9*64))*randn(3,3,channels,64,'single'),...
    'Bias',zeros(1,1,64,'single'))
    batchNormalizationLayer('Name','bn11')
    reluLayer('Name','relu11')
    
    convolution2dLayer(3,num_channels,'NumChannels','Padding','same','Name','conv12')
    batchNormalizationLayer('Name','bn12')
    reluLayer('Name','relu12')
    
     convolution2dLayer(3,num_channels,'NumChannels','Padding','same','Name','conv13')
    batchNormalizationLayer('Name','bn13')
    reluLayer('Name','relu13')
    
     convolution2dLayer(3,num_channels,'NumChannels','Padding','same','Name','conv14')
